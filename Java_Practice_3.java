...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(doesBlockFit());/// 3
        int a = 243;
    ...
    static boolean doesBlockFit () {
        return
                Shape.length <= Hole.length
                | Shape.width <= Hole.length
                && Shape.length <= Hole.width
                | Shape.width <= Hole.width
                && Shape.height <= Hole.length
                | Shape.height <= Hole.width;
    } /// 3
    ...
    static boolean numCheck (int a) {
        ...
        return ((a % 2 == 0 && sqrd_sum % 2 == 0) | (a % 2 == 1 && sqrd_sum % 2 == 1));
    } /// 4
